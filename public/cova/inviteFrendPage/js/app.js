  ...
  window.onscroll = function () {
    if (mobileAndTabletCheck() == false) {
        ...
        if (window.pageYOffset > 0) {
            ...
            // src img logo
            document.getElementById("logo_purple").classList.remove("hide");
            document.getElementById("logo_purple").classList.add("show");
            document.getElementById("hamburger").classList.add("margin-0");
            document.getElementById("logo_white").classList.add("hide");
            document.getElementById("logo_white").classList.remove("show");

        } else {
            header.classList.remove("header-bg");
            document.getElementById("logo_purple").classList.remove("show");
            document.getElementById("logo_purple").classList.add("hide");
            document.getElementById("logo_white").classList.add("show");
